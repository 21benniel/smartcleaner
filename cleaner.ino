...
const char* password = "johnbenniel";
...
void loop()
{
    ...
    command = checkClient ();
         ...
         if (command == "forward" || command == "move forward" || command == "a frente")  forwardMotor();
    else if (command == "reverse" || command == "move reverse"|| command == "voltar") reverseMotor();
    else if (command == "left"    || command == "move left") leftMotor();    
    else if (command == "right"   || command == "move right") rightMotor();     
    else if (command == "stop"    || command == "stop cleaning" || command == "parar" || command == "parando")     stopMotor();     
